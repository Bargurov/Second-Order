...
The earlier untracked-candidate triage remains below. These are the final recommended actions for the remaining candidates; no files were deleted, staged, or committed while preparing this table.
